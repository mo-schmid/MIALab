...
The following three figures and the corresponding tables show the results of PKF with optimized parameter ($variance = 20$ and $preserve\; background = true$). In appendix \ref{sec_bb} the boxplots are shown again in full size.
...
\subsection{DCRF}
The following three figures and the corresponding tables show the results of DCRF with optimized parameter ($\theta_{\alpha} = 7$, $\theta_{\beta} = 3$ and $\theta_{\gamma} = 1$). In appendix \ref{sec_bb} the boxplots are shown again in full size.
\begin{figure}[ht]
\centering
